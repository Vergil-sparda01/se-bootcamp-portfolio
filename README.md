...
-   ให้ช่วย gen รูปภาพ
    ช่วย gen infographic

### Prompt ที่ฉันใช้
```ทำเป็น infographic แนวนอน มีชื่อพงศกร วงศ์ใหญ่ เปลี่ยนตาเป็นสีฟ้าเหมือนโกโจ ใส่สิ่งที่สนใจ เกี่ยวกับ วิศวกรรมซอฟต์แวร์ มา4อย่าง

```

### ฉันตรวจสอบคำตอบของ AI อย่างไร
- อ่านและตรวจสอบคำแปลกๆ
...
```text
https://github.com/Vergil-sparda01/se-bootcamp-portfolio.git
```